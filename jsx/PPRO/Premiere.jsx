...
$._PPP_={
	...
	alertOutput: function(output) {
		alert("API Response: " + output);
		return "output";
	  },

	getName : function(mediaName){
		alert("Name: " + mediaName);
	},

	getVideo : function (){
		var sequence = app.project.activeSequence;
		var video = sequence.videoTracks[0].clips[0];
		return video.name;
	  },

	testExtension : function(){
		console.log("Hi, " + "video name is " + this.getVideo());
	},
	...
	addFiles: function(data) {
		...
		for (var key in elements) {
		  if (elements.hasOwnProperty(key)) {
			...
			for (j = 0; j < app.project.rootItem.children.numItems; j++) {
			...
			for (k = 0; k < app.project.rootItem.children.numItems; k++) {
			  ...
			  if (importedItem) {
				...
				if (sequence) {
				  try {
					...
					alert("Error inserting clip: " + error.message);
				  }
				} else {
